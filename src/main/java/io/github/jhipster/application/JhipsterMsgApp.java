...
@EnableZuulProxy
public class JhipsterMsgApp {

    private static final Logger log = LoggerFactory.getLogger(JhipsterMsgApp.class);

    private final Environment env;

    public JhipsterMsgApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipsterMSG.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterMsgApp.class);
